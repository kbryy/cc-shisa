...
const sampleEntries: LogEntry[] = [
  { ts: "2026-04-30T10:00:00Z", command: "ls", originalAction: "allow", class: "local.read", reason: "directory listing", matchedRule: "coreutils.list" },
  { ts: "2026-04-30T10:01:00Z", command: "ls -la", originalAction: "allow", class: "local.read", reason: "directory listing", matchedRule: "coreutils.list" },
  { ts: "2026-04-30T10:02:00Z", command: "git status", originalAction: "allow", class: "local.read", reason: "git status", matchedRule: "git.status" },

...
const positives: Case[] = [
  ...
  { cmd: "rm -rf .git", expectClass: "local.write.destroy", expectRuleId: "core.rm.rf.dotgit" },
  ...
  { cmd: "git push --force origin main", expectClass: "remote.write.destroy", expectRuleId: "core.git.push.force" },
  { cmd: "git push -f origin main", expectClass: "remote.write.destroy", expectRuleId: "core.git.push.force" },
  { cmd: "git push --force-with-lease origin main", expectClass: "remote.write.destroy", expectRuleId: "core.git.push.force" },
  { cmd: "git reset --hard HEAD~1", expectClass: "local.write.destroy", expectRuleId: "core.git.reset.hard" },

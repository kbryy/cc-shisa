...
const positives: Case[] = [
  ...
  { cmd: "rm -rf .git", expectClass: "irreversible-local", expectRuleId: "core.rm.rf.dotgit" },
  ...
  { cmd: "git push --force origin main", expectClass: "irreversible-remote", expectRuleId: "core.git.push.force" },
  { cmd: "git push -f origin main", expectClass: "irreversible-remote", expectRuleId: "core.git.push.force" },
  { cmd: "git push --force-with-lease origin main", expectClass: "irreversible-remote", expectRuleId: "core.git.push.force" },
  { cmd: "git reset --hard HEAD~1", expectClass: "irreversible-local", expectRuleId: "core.git.reset.hard" },
